...
export function get_today_test_data(data) {
    return request({
        method: 'POST',
        url: `/quality/test_data/get_yesterday_test_data`,
        data
    })
}
...
export function list_month_total_single_tce(data) {
    return request({
        method: 'POST',
        url: `/ee/energy_consumption/list_month_total_single_tce`,
        data
    })
}

export function get_total_and_single_target(params) {
    return request({
        method: 'GET',
        url: `/ee/energy_consumption/get_total_and_single_target`,
        params
    })
}
...
export function list_sankey_diagram(params) {
    return request({
        method: 'GET',
